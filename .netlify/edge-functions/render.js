...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    imports = ["_app/immutable/entry/layout.svelte.a83a0732.js", "_app/immutable/chunks/index.c1ef6ebd.js"];
    stylesheets = [];
    fonts = [];
  }
});
...
var css$1, Tile, css, Page;
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_page.svelte.js"() {
    init_chunks();
    css$1 = {
      code: ".tile.svelte-rdoywq{text-align:center;cursor:pointer}",
      map: null
    };
    Tile = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { audioSrc } = $$props;
      let { name } = $$props;
      if ($$props.audioSrc === void 0 && $$bindings.audioSrc && audioSrc !== void 0)
        $$bindings.audioSrc(audioSrc);
    ...
    css = {
      code: ".centered-text.svelte-1ht035t{text-align:center}p.svelte-1ht035t{font-size:1.5rem}.container.svelte-1ht035t{padding-top:5%;margin:auto;display:grid;grid-template-columns:repeat(3, 1fr);justify-items:center;align-items:center;gap:1rem;width:50%}.card.svelte-1ht035t{width:50%;height:50%;background-color:#f5f5f5;border-radius:10px;box-shadow:0 0 10px rgba(0, 0, 0, 0.2);display:flex;flex-direction:column;justify-content:center;align-items:center;padding:1rem;gap:2rem}.card.svelte-1ht035t:hover{cursor:pointer;background-color:#e5e5e5}.warning.svelte-1ht035t{font-size:2rem;color:red;text-align:center;text-transform:uppercase}",
      map: null
    };
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$result.css.add(css);
      return `<h1 class="centered-text svelte-1ht035t">Welcome to the Wall of Best of F**kFace!</h1>
<p class="centered-text svelte-1ht035t">Listen to the original here <a href="https://www.youtub@e.com/watch?v=_5v7MpXPfjk">here!</a> <br>(If you don&#39;t think fart jokes are funny, you may want to leave now)
</p>
<p class="centered-text svelte-1ht035t">I really can&#39;t say why exactly I made this, other than I got bored and this
  popped into my head. I hope you enjoy it!
</p>
<p class="warning svelte-1ht035t">headphone users and anyone in public warning!!!! <br>some of these clips are
  loud!!!<br>you might want to turn your volume down
</p>



<div class="container svelte-1ht035t">${each(tiles, (tile) => {
        return `<div class="card svelte-1ht035t">${validate_component(Tile, "Tile").$$render($$result, { audioSrc: tile.audioSrc, name: tile.name }, {}, {})}
    </div>`;
      })}
</div>`;
    });
